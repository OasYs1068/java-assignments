...
public class GourmetCoffee {
    ...
    public void displayNumberOfOrders(Product product) {
        ...
        while (orderIterator.hasNext()) {
            Iterator<OrderItem> orderItemIterator = orderIterator.next().iterator();
            while (orderItemIterator.hasNext()) {
                OrderItem nextItem = orderItemIterator.next();
                if (nextItem.getProduct().equals(product)) {
                    counter++;
                }
            }
        }
        System.out.println("The number of orders that contain a specified product " + product.getCode() + " is " + counter);
    ...
    public void displayTotalQuantityOfProducts() {
        ...
        while (productIterator.hasNext()) {
            ...
            while (orderIterator.hasNext()) {
                ...
                while (orderItemIterator.hasNext()) {
                    OrderItem nextItem = orderItemIterator.next();
                    if (nextItem.getProduct().equals(nextProduct)) {
                        counter = counter + nextItem.getQuantity();
                    }
                }
            }
            System.out.println(nextProduct.getCode() + " " + counter);
        }
